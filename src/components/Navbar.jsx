...
import {Menu, AppBar, IconButton,Button, InputBase, Toolbar, useTheme, Box, Typography, MenuItem } from '@mui/material';
...
const handleClose=()=> setAnchorEl(null)
    return (
        ...
        >
          ...
          <FlexBetween>
              <Button onClick={handleClick} sx={{display:'flex', justifyContent:'space',
               alignItems:'center', textTransform:'none', gap:'1rem'}}>
                 <Box component="img" alt='profile' src="" height="35px" width="35px" borderRadius='50%' sx={{objectFit:"cover"}} />
                 <Box textAlign="left">
